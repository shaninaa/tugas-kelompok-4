...
<div class="main-content">
  <section class="section">
          <div class="card">
            ...
            <div class="card-body">
                <div>
                    <a href="/pembelian/addPembelian" style="float: right;" class="btn btn-icon icon-left btn-primary"><i class="fas fa-plus"></i>Tambah Data</a>
                </div>
                  ...
                  <tbody>
                    @foreach($pembelian as $data)
                        <tr>
                            ...
                            <td>
                            <form action="/pembelian/{{$data->id_pembelian}}" method='POST' class="form-inline">
                                @csrf
                                {{ method_field('DELETE')}}
                                <button style="float: right;" class="fa fa-trash btn btn-sm btn-danger mr-2 mb-2"></button>
                                <a href="/pembelian/editPembelian/{{$data->id_pembelian}}" style="float: right;" class=" fa fa-edit btn btn-sm btn-primary mr-2 mb-2 ">
                                  Edit
                                </a>
                              </form>
                            </td>
