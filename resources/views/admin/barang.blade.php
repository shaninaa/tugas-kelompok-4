...
<div class="main-content">
  <section class="section">
          <div class="card">
            ...
            <div class="card-body">
                <div>
                    <a href="/barang/addbarang" style="float: right;" class="btn btn-icon icon-left btn-primary"><i class="fas fa-plus"></i>Tambah Data</a>
                </div>
                  ...
                  <tbody>
                    @foreach($barang as $data)
                        <tr>
                            ...
                            <td>{{ $data->satuan}}</td>
                            <td>
                              <form action="/barang/{{$data->id_barang}}" method='POST' class="form-inline">
                                @csrf
                                {{ method_field('DELETE')}}
                                <button style="float: right;" class="fa fa-trash btn btn-sm btn-danger mr-2 mb-2"></button>
                                <a href="/barang/editbarang/{{$data->id_barang}}" style="float: right;" class=" fa fa-edit btn btn-sm btn-primary mr-2 mb-2 ">
                                  Edit
                                </a>
                              </form>
                            </td>
